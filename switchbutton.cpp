...
#include <QPainter>
SwitchButton::SwitchButton(const QColor onColor, Style style, QWidget* parent)
    : QWidget(parent)
    , _value(false)
    , _duration(100)
    , _enabled(true)
...
//    _lg.setColorAt(0, QColor(200, 50, 50));
//    _lg.setColorAt(0.25, QColor(255, 154, 50));
//    _lg.setColorAt(0.95, QColor(200, 50, 50));
    _lg.setColorAt(0, color);
    _lg.setColorAt(0.25, color);
    _lg.setColorAt(0.95, color);
